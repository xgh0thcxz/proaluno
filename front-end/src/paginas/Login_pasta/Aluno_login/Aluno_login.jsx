...
import { useAlunoLogin } from './AL_JS';
import s from './AL_CSS.module.css';

import proaluno_logo_branca from '../../../imagens/logo_pa_branca.png';

export default function Aluno_login() {
  const {
        ...
        <section className={s.brandPanel}>
          <div className={s.brandContent}>
            <div className={s.logoContainer}>
              <img src={proaluno_logo_branca} alt="Proaluno Logo" className={s.logo} />
            </div>
          ...
          <div className={s.loginFormContainer}>
            <form className={s.loginForm} onSubmit={handleLoginSubmit} noValidate>
              ...
              <div className={s.formHeader}>
                ...
                <p className={s.formSubtitle}>ALUNO</p>
              </div>
              ...
              <div className={s.forgotPassword}>
                <a href="#" onClick={(e) => { e.preventDefault(); setIsModalOpen(true); }}>
                  <i className="fas fa-key" /> Esqueceu sua senha?
                </a>
              </div>

              <button type="submit" className={s.submitBtn}>
                Entrar <i className="fas fa-arrow-right" />
              </button>
            ...
            {!showSuccess ? (
              <>
                ...
                <form onSubmit={handleRecoverySubmit} noValidate>
                  ...
                  <button type="submit" className={s.submitBtn}>
                    <i className="fas fa-paper-plane" /> Enviar Link
                  </button>
                </form>
              </>
            ) : (
