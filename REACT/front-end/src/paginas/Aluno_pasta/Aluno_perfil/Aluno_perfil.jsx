...
import styles from './AP_CSS.module.css';
      ...
      <section className={styles.profilePage}>
        ...
        <div className={styles.pageContent}>
          <main className={styles.profileCard}>
            ...
            {/* ── Manifestação ── */}
            <div className={styles.manifestationSection}>
              <h3 className={styles.manifestationTitle}>ACOMPANHE SUA MANIFESTAÇÃO</h3>
              <p className={styles.manifestationDescription}>
                Digite seu número de protocolo abaixo para consultar o andamento da sua manifestação
              </p>

              <div className={styles.protocolGroup}>
                <label htmlFor="protocolInput">Número de Protocolo:</label>
                <input
                  type="text"
                  id="protocolInput"
              ...
              <p className={styles.statusHeading}>Status da Manifestação:</p>
              <div className={styles.statusCard}>
                <h4 className={styles.statusTitle}>
                  {status.title}
                  <span className={`${styles.statusBadge} ${styles.statusAnalysis}`}>
                    {status.badge}
                  </span>
                </h4>
