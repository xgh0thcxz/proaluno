...
import styles from './C_FO.module.css';
        ...
        <div className={styles.footerContainer}>
          ...
          <div className={styles.footerLinks}>
            <div className={styles.footerColumn}>
              <h4>Institucional</h4>
              <ul>
                <li><a href="colab_sobre">Sobre Nós</a></li>
                <li><a href="colab_equipe">Nossa Equipe</a></li>
            ...
            <div className={styles.footerColumn}>
              <h4>Funções</h4>
              <ul>
                <li><a href="colab_ver_manifestacoes">Acompanhar Manifestações</a></li>
                <li><a href="colab_status_manifestacoes">Estado das Manifestações</a></li>
                <li><a href="colab_encaminhar">Encaminhar Manifestações</a></li>
                <li><a href="colab_responder">Responder Manifestações</a></li>
              </ul>
            </div>
